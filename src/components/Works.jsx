    ...
    <>
      ...
      <div className="w-full flex ">
        <motion.p
          ...
          className="mt-3 text-secondary text-[17px] max-w-3xl leding-[30px]"
        >
          Following projects showcases my skills and experience through ral
          world examples of my work. Each project is briefly described with
          links to code repositories and live demos in it. It reflects my
          abiliti to solve complex problems, work with different technologies,
